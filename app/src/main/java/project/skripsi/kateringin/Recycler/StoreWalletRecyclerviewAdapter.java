...
public class StoreWalletRecyclerviewAdapter extends RecyclerView.Adapter<StoreWalletRecyclerviewAdapter.ViewHolder> {
    ...
    public StoreWalletRecyclerviewAdapter(ArrayList<WalletHistory> walletHistories, Context context) {
    ...
    @NonNull
    @Override
    public StoreWalletRecyclerviewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.component_wallet_item_card, parent, false);
        return new ViewHolder(view);
    }
    @SuppressLint("NotifyDataSetChanged")
    @Override
    public void onBindViewHolder(@NonNull StoreWalletRecyclerviewAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
