...
import project.skripsi.kateringin.Util.BottomSheetDialog.BottomSheetDialogStoreWithdrawConfirmation;
import project.skripsi.kateringin.Util.UtilClass.IdrFormat;

public class StoreWithdrawController extends AppCompatActivity {
                            ...
                            documentReference.get().addOnCompleteListener(innerTask -> {
                                if(innerTask.isSuccessful()){
                                    ...
                                    if(documentSnapshot.exists()){
                                       ...
                                       BottomSheetDialogStoreWithdrawConfirmation bottomSheetDialogFragment = new BottomSheetDialogStoreWithdrawConfirmation();
