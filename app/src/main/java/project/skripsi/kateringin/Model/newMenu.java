...
public class newMenu implements Serializable {
    ...
    public newMenu(String menuId, String storeId, String menuName, String menuDescription, String menuPhotoUrl, int menuCalorie, int menuPrice, Double menuRating, Boolean isDiet, Boolean isNoodle, Boolean isPork, Boolean isRice, Boolean isSoup, Boolean isVegan) {
        this.menuId = menuId;
